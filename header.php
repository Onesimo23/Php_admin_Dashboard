<?php
 $base_url = 'http://localhost/php_admin_dashboard/';
 ?>

<!DOCTYPE html>
<html lang="en">
<head>
	<base href="http://localhost/php_admin_dashboard/">
    <meta charset="utf-8">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="user/index.php" aria-expanded="false">
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						<div class="side-bar-profile-img">
							<img src="assets/images/Transparente logo.png" alt="">
						</div>
						<div class="profile-info1">
							<center><h4 class="fs-18 font-w500">José Onésimo </h4></center>
							<center><span>onesimonuvunga@gmail..</span></center>
						</div>
