                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
									<div class="text-center mb-3">
										<a href="#"><img width="30%" height="30%"   src="assets/images/Transparente logo.png" alt=""></a>
									</div>
                                        ...
                                        <div class="row d-flex justify-content-between mt-4 mb-2">
                                            <div class="mb-3">
                                               <div class="form-check custom-checkbox ms-1">
													...
													<label class="form-check-label" for="basic_checkbox_1">Lembrar das minhas preferencias</label>
												</div>
                                            </div>
                                            <div class="mb-3">
                                                <a href="assets/page-forgot-password.html">Esqueceu a Senha?</a>
                                            </div>
                                        </div>
